...
COPY openvswitch2.16-2.16.0-65.el8fdp.x86_64.rpm python3-openvswitch2.16-2.16.0-65.el8fdp.x86_64.rpm openvswitch2.16-test-2.16.0-65.el8fdp.noarch.rpm /root/
COPY ovn-2021-21.12.0-custom_xs_patches.42.el8fdp.x86_64.rpm ovn-2021-central-21.12.0-custom_xs_patches.42.el8fdp.x86_64.rpm ovn-2021-host-21.12.0-custom_xs_patches.42.el8fdp.x86_64.rpm ovn-2021-vtep-21.12.0-custom_xs_patches.42.el8fdp.x86_64.rpm /root/
