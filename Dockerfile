...
ARG ovnver=21.09.0-22.el8fdp

COPY ovn21.09-21.09.0-25.el8fdp.x86_64.rpm ovn21.09-central-21.09.0-25.el8fdp.x86_64.rpm ovn21.09-host-21.09.0-25.el8fdp.x86_64.rpm ovn21.09-vtep-21.09.0-25.el8fdp.x86_64.rpm /root/
COPY openvswitch2.16-2.16.0-22.el8fdp.x86_64.rpm openvswitch2.16-devel-2.16.0-22.el8fdp.x86_64.rpm python3-openvswitch2.16-2.16.0-22.el8fdp.x86_64.rpm openvswitch2.16-ipsec-2.16.0-22.el8fdp.x86_64.rpm /root/
